...
// console.log(arr, "arr`"); // []
arr = "234";
// console.log('5-2' == 3, "+---333)")//false
// console.log('5-2' == '3', "**+---333)")//false
// console.log('5-1' - 1 == '3', "**+---3)")// false
// console.log('5-1' - 1 == 3, "////**+---3)")// false
...
// console.log(isNaN('hello') == isNaN('hello'), "dferccffff"); // true
...
// console.log(false === 0, "-6==");//false
// console.log(false == 0, "0-6==");//ttttttt  true
// console.log(false == "", "=0-6==");//tttttt  true
...
// console.log(null == "NaN", "*2=0-6==");//fffffffffffff
